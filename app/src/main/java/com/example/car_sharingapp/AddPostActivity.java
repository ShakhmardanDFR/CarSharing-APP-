...
public class AddPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Добавить пост");
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            if(TextUtils.isEmpty(title)){
                title_blog.setError("Требуется название");
            }
            else if(TextUtils.isEmpty(description)){
                description_blog.setError("Описание обязательно");
            }
            else {
    ...
    private void uploadData(String title, String description) {
        pd.setMessage("Публикация поста");
        pd.show();
        ...
        if(blog_image.getDrawable()!=null){
            ...
            //now we will crate the reference of storage in firebase
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if(uriTask.isSuccessful()){
                                ...
                                //nowwe will post the data to firebase database
    ...
    private void imagePickDialog() {
        //here 0 is for camera an 1 is for gallery
    ...
    private void galleryPick() {
        ...
        //this is for all type of images
