...
public class ForgotPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Забыли Пароль");
        ...
        recoverPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(etEmail)){
                    email.setError("Электронная почта требуется");
                }
                else{
        ...
        auth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    pd.dismiss();
                    Toast.makeText(ForgotPasswordActivity.this,"Пожалуйста, проверьте отправку ссылки на электронную почту",Toast.LENGTH_SHORT).show();
